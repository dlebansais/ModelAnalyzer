...
{
    private Expression? ParseExpression(ReadOnlyFieldTable fieldTable, Method? hostMethod, Field? resultField, Unsupported unsupported, LocationContext locationContext, ExpressionSyntax expressionNode, bool isNested)
    {
        ...
        if (expressionNode is BinaryExpressionSyntax BinaryExpression)
            NewExpression = TryParseBinaryExpression(fieldTable, hostMethod, resultField, unsupported, locationContext, BinaryExpression, ref IsErrorReported, ref Location);
        else if (expressionNode is PrefixUnaryExpressionSyntax PrefixUnaryExpression)
            NewExpression = TryParsePrefixUnaryExpression(fieldTable, hostMethod, resultField, unsupported, locationContext, PrefixUnaryExpression, ref IsErrorReported, ref Location);
        else if (expressionNode is IdentifierNameSyntax IdentifierName)
            NewExpression = TryParseVariableValueExpression(fieldTable, hostMethod, resultField, IdentifierName);
            ...
            NewExpression = TryParseParenthesizedExpression(fieldTable, hostMethod, resultField, unsupported, locationContext, ParenthesizedExpression, ref IsErrorReported);
        else
    ...
    private Expression? TryParseBinaryExpression(ReadOnlyFieldTable fieldTable, Method? hostMethod, Field? resultField, Unsupported unsupported, LocationContext locationContext, BinaryExpressionSyntax binaryExpression, ref bool isErrorReported, ref Location location)
    {
        Expression? NewExpression = null;
        Expression? LeftExpression = ParseExpression(fieldTable, hostMethod, resultField, unsupported, locationContext, binaryExpression.Left, isNested: true);
        Expression? RightExpression = ParseExpression(fieldTable, hostMethod, resultField, unsupported, locationContext, binaryExpression.Right, isNested: true);
    ...
    private Expression? TryParsePrefixUnaryExpression(ReadOnlyFieldTable fieldTable, Method? hostMethod, Field? resultField, Unsupported unsupported, LocationContext locationContext, PrefixUnaryExpressionSyntax prefixUnaryExpression, ref bool isErrorReported, ref Location location)
    {
        Expression? NewExpression = null;
        Expression? OperandExpression = ParseExpression(fieldTable, hostMethod, resultField, unsupported, locationContext, prefixUnaryExpression.Operand, isNested: true);
    ...
    private Expression? TryParseVariableValueExpression(ReadOnlyFieldTable fieldTable, Method? hostMethod, Field? resultField, IdentifierNameSyntax identifierName)
    {
        Expression? NewExpression = null;
        string VariableName = identifierName.Identifier.ValueText;

        if (TryFindVariableByName(fieldTable, hostMethod, resultField, VariableName, out IVariable Variable))
    ...
    private Expression? TryParseParenthesizedExpression(ReadOnlyFieldTable fieldTable, Method? hostMethod, Field? resultField, Unsupported unsupported, LocationContext locationContext, ParenthesizedExpressionSyntax parenthesizedExpression, ref bool isErrorReported)
    {
        Expression? NewExpression = null;
        Expression? NestedExpression = ParseExpression(fieldTable, hostMethod, resultField, unsupported, locationContext, parenthesizedExpression.Expression, isNested: true);
