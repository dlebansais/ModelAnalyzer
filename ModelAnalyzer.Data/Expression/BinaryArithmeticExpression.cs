...
internal class BinaryArithmeticExpression : Expression
{
    ...
    {
        ExpressionType LeftExpressionType = Left.GetExpressionType(fieldTable, hostMethod, resultLocal);
        ExpressionType RightExpressionType = Right.GetExpressionType(fieldTable, hostMethod, resultLocal);
